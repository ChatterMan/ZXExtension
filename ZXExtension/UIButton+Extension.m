...
- (void)zx_setZXButtonImageTitleStyle:(ZXButtonImageTitleStyle)style padding:(CGFloat)padding
{
    if (self.imageView.image != nil && self.titleLabel.text != nil)
    {
        ...
        switch (style) {
            case ZXButtonImageTitleStyleLeft:
                if (padding != 0)
                {
                ...
                break;
            case ZXButtonImageTitleStyleRight:
            {
                //图片在右，文字在左
                self.titleEdgeInsets = UIEdgeInsetsMake(0,
                ...
                break;
            case ZXButtonImageTitleStyleTop:
            {
                //图片在上，文字在下
                ...
                break;
            case ZXButtonImageTitleStyleBottom:
            {
                //图片在下，文字在上。
                ...
                break;
            case ZXButtonImageTitleStyleCenterTop:
            {
                ...
                break;
            case ZXButtonImageTitleStyleCenterBottom:
            {
                ...
                break;
            case ZXButtonImageTitleStyleCenterUp:
            {
                ...
                break;
            case ZXButtonImageTitleStyleCenterDown:
            {
                ...
                break;
            case ZXButtonImageTitleStyleRightLeft:
            {
                //图片在右，文字在左，距离按钮两边边距
            ...
            case ZXButtonImageTitleStyleLeftRight:
            {
                //图片在左，文字在右，距离按钮两边边距
